...
# Author  : Vlukss
# (C) Copyright 2021-2022 By Vluks Store
# =========================================
...
echo -e "         OWNER : ${GREEN}Vluks ${NC}${YELLOW}(${NC} ${GREEN}Vluks ${NC}${YELLOW})${NC}"
echo -e "       © Copyright By Vluks ${YELLOW}(${NC} 2024-9999 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
